      ...
      <div className="flex-1 overflow-auto">
        <table className="w-full text-left border-collapse">
          ...
          <tbody className="divide-y divide-slate-100 text-base">
            ...
            {filteredRequisitantes.length === 0 && (
              <tr>
                <td colSpan={4} className="px-6 py-8 text-center text-slate-500">
                  Nenhum requisitante encontrado.
                </td>
              </tr>
            )}
          </tbody>
          ...
          <>
            ...
            >
              <div className="flex items-center justify-between p-6 border-b border-slate-100">
                <div>
                  <h2 className="text-lg font-bold text-slate-800">Cadastrar Requisitante</h2>
                  <p className="text-sm text-slate-500 mt-1">Preencha os dados do novo requisitante</p>
                </div>
                <button 
                  onClick={closeModal}
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="space-y-1.5 col-span-2">
                    ...
                    <input 
                      ...
                      placeholder="Ex: lucas.oliveira@empresa.com"
                      className="w-full px-3 py-2 bg-white border border-slate-300 rounded-lg text-sm focus:outline-none focus:border-[#3B82F6] focus:ring-1 focus:ring-[#3B82F6] transition-all"
                    />
                  </div>
