  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 pointer-events-none">
        ...
        >
          <div className="flex justify-end p-4 pb-0 bg-white">
            {onClose && (
              <button 
                onClick={onClose}
              ...
              {step === 1 && (
                ...
                >
                  <div className="text-center mb-10">
                    <h2 className="text-2xl font-bold text-[#0C2340]">Nova Requisição</h2>
                    <p className="text-slate-500 mt-2">Busque os materiais desejados utilizando um dos métodos abaixo.</p>
                  </div>
                  <form onSubmit={handleSearch} className="max-w-2xl mx-auto">
                    <div className="relative flex items-center border border-slate-200 rounded-xl p-1.5 bg-white focus-within:ring-2 focus-within:ring-[#8A95A5] focus-within:border-transparent transition-all">
                      ...
                      <input
                        ...
                        className="flex-1 px-4 py-3 bg-transparent focus:outline-none text-slate-700 text-base"
                      />
                      <button
                        type="submit"
                        disabled={!searchValue || isSearching}
                        className="px-8 py-3 bg-[#8A95A5] hover:bg-[#737E8F] text-white rounded-lg font-bold transition-colors disabled:opacity-50 flex items-center gap-2 shrink-0"
                      >
                        {isSearching ? (
